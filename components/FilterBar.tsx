...
const FilterBar: React.FC<FilterBarProps> = ({ filters, onFilterChange }) => {
  ...
  return (
    <div className="flex flex-col space-y-6 pb-6">
      ...
      <div className="w-full glass-panel p-1.5 rounded-xl flex items-center space-x-2">
        {/* Filters Container */}
        ...
        <div className="relative group">
            ...
            <select 
                className="appearance-none bg-black/40 border border-transparent text-white py-2 pl-16 pr-8 rounded-lg text-sm focus:outline-none focus:border-neutral-600 focus:bg-black hover:bg-white/5 transition-colors cursor-pointer font-medium"
                value={filters.genre}
        ...
        <div className="relative group">
            ...
            <select 
                className="appearance-none bg-black/40 border border-transparent text-white py-2 pl-12 pr-8 rounded-lg text-sm focus:outline-none focus:border-neutral-600 focus:bg-black hover:bg-white/5 transition-colors cursor-pointer font-medium"
                value={filters.key}
        ...
        {/* BPM Range */}
         <div className="flex items-center space-x-0.5 bg-black/40 rounded-lg px-3 py-2 border border-transparent hover:border-neutral-800 transition-colors">
             <span className="text-[10px] text-neutral-500 font-mono mr-2">BPM</span>
             <input 
                type="number" 
                placeholder="0"
                className="w-8 bg-transparent text-sm text-white focus:outline-none text-center font-mono border-b border-transparent focus:border-white/20 transition-colors"
             />
