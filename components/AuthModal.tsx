...
import { X, Mail, Lock, ArrowRight, Music, Mic2, Settings, CheckCircle, Terminal, Briefcase, Headphones } from 'lucide-react';
                ...
                <div className="px-8 pb-8">
                    {mode === 'login' ? (
                        <div className="space-y-5 animate-in slide-in-from-bottom-4 duration-300">
                            ...
                            <button className="w-full py-3 bg-white text-black font-bold rounded-lg text-xs hover:bg-neutral-200 transition-colors opacity-50 cursor-not-allowed uppercase tracking-wide" disabled>
                                Login
                            </button>

                            <div className="relative py-2">
                                <div className="absolute inset-0 flex items-center"><div className="w-full border-t border-neutral-800"></div></div>
                                <div className="relative flex justify-center text-[10px] uppercase font-bold"><span className="bg-[#0a0a0a] px-2 text-neutral-600">Or continue with</span></div>
                            </div>

                            <button 
                                onClick={handleDemoLogin}
                                className="w-full py-3 bg-primary text-black font-bold rounded-lg text-xs hover:bg-primary/90 transition-colors shadow-[0_0_20px_rgba(var(--primary),0.2)] flex items-center justify-center gap-2 uppercase tracking-wide"
                            >
                                {isLoading ? 'Authenticating...' : 'Demo Account Access'}
                        ...
                        <div className="animate-in slide-in-from-right-4 duration-300">
                            ...
                            {step === 2 && (
                                <div className="space-y-5 animate-in slide-in-from-right-4 duration-300">
                                    ...
                                    <input className="w-full bg-neutral-900 border border-neutral-800 rounded-lg px-4 py-2.5 text-sm text-white focus:border-primary/50 focus:outline-none placeholder-neutral-600" placeholder="Username" />
                                    <input className="w-full bg-neutral-900 border border-neutral-800 rounded-lg px-4 py-2.5 text-sm text-white focus:border-primary/50 focus:outline-none placeholder-neutral-600" placeholder="Email" />
                                    <input className="w-full bg-neutral-900 border border-neutral-800 rounded-lg px-4 py-2.5 text-sm text-white focus:border-primary/50 focus:outline-none placeholder-neutral-600" type="password" placeholder="Password" />
                                    
                                    <div className="pt-2">
                                        <button 
                                            onClick={handleDemoLogin}
                                            className="w-full py-3 bg-primary text-black font-bold rounded-lg text-xs hover:bg-primary/90 transition-colors shadow-[0_0_20px_rgba(var(--primary),0.2)] uppercase tracking-wide"
                                        >
