...
const LibraryPage: React.FC<LibraryPageProps> = ({
  ...
  // Mock data filtering
  const displayProjects = activeTab === 'liked' ? MOCK_PROJECTS.slice(0, 3) 
                        : activeTab === 'purchased' ? MOCK_PROJECTS.slice(2, 5)
                        : MOCK_PROJECTS;
  ...
  return (
    <div className="w-full max-w-[1600px] mx-auto pb-32 pt-6 px-6 lg:px-8 animate-in fade-in duration-500">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-8 gap-4">
            <div>
                <h1 className="text-3xl font-black text-white mb-1">My Library</h1>
                <p className="text-neutral-500 text-sm">Your collection of beats, songs, and playlists.</p>
            </div>
